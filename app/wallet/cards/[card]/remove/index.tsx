  ...
  return (
    <CommonAppLayout
      ...
      header={
        <Header
          leftComponent={
            <HeaderLeftIcon text="Card" onPress={() => router.dismiss()} />
          }
          rightComponent={
            <Image
              style={{
    ...
    >
      ...
      >
        <PageTitleSection
          title={"Did you know?"}
          description={"You can hide your card instead of removing it"}
          titleStyle={{ fontSize: SIZES.SIZE_22 }}
          descriptionStyle={{ fontSize: SIZES.SIZE_17 }}
        />
        <View style={{ gap: 12, alignItems: "center" }}>
          <Text style={{ textAlign: "center", width: 280 }}>
            By hiding your card you will stop earning rewards. Your profile and
            history will not be visible until you unhide it.
          </Text>
          <Text style={{ textAlign: "center", width: 280 }}>
            By removing your card you will stop earning rewards and your card
        ...
        <CommonButtonWithLinks
          ...
          text="Hide Card"
          onPress={() => router.replace(ROUTES.WALLET_CARDS)}
        >
          <CommonLink
            text="Remove"
      ...
      >
        <CommonPageTitleSection
          ...
          title={""}
          description="You’re about to remove your Lexi’s card."
        />
        <CommonButtonWithLinks
          style={{
            marginTop: 24,
          ...
          onPress={() => {
            ...
            // Lowest stack should be the wallet home
            router.dismissAll();
